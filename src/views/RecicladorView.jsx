          ...
          >
            {activePickup && (
              <motion.div 
                initial={{ y: 100 }} 
                animate={{ y: 0 }}
                className="absolute bottom-4 left-4 right-4 glass-panel p-4 md:p-6 bg-black/60 backdrop-blur-xl border-green-500/30 flex flex-col md:flex-row items-center justify-between gap-3 md:gap-6 z-[9999]"
              >
