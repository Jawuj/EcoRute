          ...
          >
            ...
            {activePickup && (
              <motion.div 
                initial={{ y: 100 }} 
                animate={{ y: 0 }}
                className="absolute bottom-4 left-4 right-4 glass-panel p-4 md:p-6 bg-black/80 backdrop-blur-2xl border-green-500/30 flex flex-col md:flex-row items-center justify-between gap-3 md:gap-6 z-[9999] shadow-[0_20px_50px_rgba(0,0,0,0.5)]"
              >
                <div className="flex items-center gap-4 md:gap-6">
                  ...
                  <div>
                    <p className="text-[8px] md:text-[10px] font-black text-green-500 uppercase tracking-widest text-center md:text-left">Recogida Requerida</p>
